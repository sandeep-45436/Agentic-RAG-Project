...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#07090e] text-slate-100 font-sans selection:bg-indigo-500/30 selection:text-indigo-200 relative overflow-hidden">
      ...
      {/* ── Navigation Header ── */}
      <header className="sticky top-0 z-50 backdrop-blur-xl bg-[#07090e]/80 border-b border-white/[0.06] transition-all duration-300">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3 group">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-indigo-600 to-cyan-500 flex items-center justify-center text-white shadow-lg shadow-indigo-500/25 group-hover:scale-105 transition-transform duration-300">
              <Sparkles className="w-5 h-5" />
            </div>
            <div>
              <span className="text-lg font-bold tracking-tight text-white flex items-center gap-2">
                NexusIQ <span className="text-[10px] uppercase font-semibold tracking-wider px-2 py-0.5 rounded-full bg-indigo-500/10 text-indigo-400 border border-indigo-500/20">University RAG</span>
              </span>
              <p className="text-[11px] text-slate-400 font-medium">Smart AI Campus Intelligence</p>
            </div>
          </Link>
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/faculty/login"
              className="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-semibold bg-white/[0.04] hover:bg-white/[0.08] text-purple-300 border border-purple-500/30 hover:border-purple-500/50 transition-all duration-200"
            >
            ...
            <Link
              href="/chat"
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-semibold bg-gradient-to-r from-indigo-600 to-cyan-600 hover:from-indigo-500 hover:to-cyan-500 text-white shadow-lg shadow-indigo-600/30 hover:shadow-indigo-600/50 transition-all duration-300 hover:-translate-y-0.5"
            >
      ...
      <main className="max-w-7xl mx-auto px-6 py-12 lg:py-20 flex flex-col items-center">
        ...
        <section id="playground" className="w-full py-12 scroll-mt-24">
          ...
          <div className="w-full max-w-4xl mx-auto rounded-3xl bg-[#0c0f17] border border-white/10 shadow-2xl overflow-hidden relative backdrop-blur-2xl">
            {/* Top Terminal Bar */}
            <div className="px-6 py-4 bg-[#121622] border-b border-white/[0.08] flex items-center justify-between">
            ...
            <div className="p-6 sm:p-8 space-y-6">
              ...
              <div className="flex items-start gap-4">
                <div className="w-9 h-9 rounded-xl bg-slate-800 border border-white/10 flex items-center justify-center text-xs font-bold text-slate-300 shrink-0">
                  You
                </div>
                <div className="flex-1 bg-white/[0.04] border border-white/10 rounded-2xl rounded-tl-none p-4 text-sm text-slate-200">
              ...
              <div className="flex items-start gap-4">
                <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-indigo-600 to-cyan-500 flex items-center justify-center text-white shrink-0 shadow-md shadow-indigo-500/20">
                  <Sparkles className="w-4 h-4" />
                </div>
                <div className="flex-1 bg-[#151926] border border-indigo-500/20 rounded-2xl rounded-tl-none p-5 text-sm text-slate-200 space-y-4">
                  <div className="flex items-center justify-between border-b border-white/[0.06] pb-3">
                    <span className="text-[11px] font-mono text-indigo-400 flex items-center gap-1.5">
                      <BookOpen className="w-3.5 h-3.5" /> Source: {selectedDemo.source}
                    </span>
                    <button
                      onClick={handleCopy}
                      className="text-xs text-slate-400 hover:text-white flex items-center gap-1 px-2 py-1 rounded bg-white/[0.04] hover:bg-white/[0.08] transition-colors"
                    >
                  ...
                  {selectedDemo.hasDownload && selectedDemo.downloadCard && (
                    <div className="mt-4 p-4 rounded-xl bg-gradient-to-r from-indigo-950/80 to-slate-900 border border-indigo-500/40 flex items-center justify-between gap-4">
                      <div className="flex items-center gap-3">
                      ...
                      <Link
                        href="/chat"
                        className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-semibold transition-colors shadow-md shadow-indigo-600/30"
                      >
