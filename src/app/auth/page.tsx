...
export default function UnifiedAuthGatewayPage() {
  ...
  return (
    <AnimatedBackground variant="subtle">
      <div className="min-h-screen w-full  text-slate-100 flex flex-col justify-center items-center p-4 sm:p-8 relative overflow-hidden font-sans">
    ...
    <AnimatedBackground variant="subtle">
      <Card
              ...
              >
                <div>
                  <CardHeader className="pb-4">
                    <div className="flex items-center justify-between mb-2">
                      <div className={`p-3 rounded-2xl ${portal.bgGlow} border border-slate-200`}>
                        <Icon className="h-6 w-6 text-slate-900" />
                      </div>
                      <Badge variant="outline" className="text-[10px] light-glass-card card-3d-inner anim-fade-up-1 text-slate-700 border-indigo-100">
                        {portal.badge}
                      </Badge>
                    </div>
                    <CardTitle className="text-lg font-bold text-slate-900 mt-1">{portal.title}</CardTitle>
                  ...
                  <CardContent className="space-y-3 text-xs pt-0">
                    <div className="p-3 rounded-xl  border border-indigo-100/80 space-y-2">
                ...
                <CardFooter className="pt-2 flex flex-col gap-2.5 border-t border-indigo-100">
                  <Link
                  ...
                  {portal.signupUrl && portal.id !== "faculty" && (
                    <Link
                      ...
                      className="w-full text-center py-2 text-xs font-medium text-slate-600 hover:text-slate-900 transition-colors"
                    >
