...
export class SkillsService {
  /**
   * Get all available skill tracks enriched with real courses from PostgreSQL
   */
    ...
    try {
      ...
      dbCourses.forEach((c) => {
        if (c.department?.code) {
          courseMap[c.department.code] = `${c.code}: ${c.title}`;
        }
      });
      ...
      return [
        {
          ...
          category: courseMap["CSE"] ? `Curriculum: ${courseMap["CSE"]}` : "Artificial Intelligence",
          level: "Advanced",
          ...
          currentModule: courseMap["CSE"] ? `Aligned to ${courseMap["CSE"]}` : "Module 10: Multi-Turn Memory & Semantic Caching",
        },
        {
          id: "track_cloud_devops",
          title: "Cloud Native & Distributed DevOps",
          category: courseMap["IT"] ? `Curriculum: ${courseMap["IT"]}` : "Cloud Architecture",
          level: "Intermediate",
          iconName: "CloudCog",
        ...
        },
        {
          ...
          category: courseMap["CS"] ? `Curriculum: ${courseMap["CS"]}` : "Software Development",
          level: "Advanced",
          iconName: "Code2",
        ...
        },
        {
          ...
          category: courseMap["ECE"] ? `Curriculum: ${courseMap["ECE"]}` : "Cybersecurity",
          level: "Intermediate",
        ...
        },
        {
          ...
          category: courseMap["MATH"] ? `Curriculum: ${courseMap["MATH"]}` : "Data Engineering",
          level: "Advanced",
        ...
        },
        {
          ...
          category: courseMap["MECH"] ? `Curriculum: ${courseMap["MECH"]}` : "Hardware & Systems",
          level: "Beginner",
          iconName: "Cpu",
          ...
          currentModule: courseMap["MECH"] ? `Aligned to ${courseMap["MECH"]}` : "Module 3: Low-Power BLE Telemetry & Sensor Arrays",
        },
      ];
    } catch {
      return [];
